//js日历
//https://www.cnblogs.com/loveyoume/p/6341567.html
(function(){
var calendar = function(calendarId){
    ...
    c.init = function(){
        ...
        loadStyles(".calendarDiv {width:361px;text-align:center;}\
            ...
            .box{margin-left:0;margin-right:10px;text-align:center;width:100%;height:22px;font-weight:bold;font-size:15px;}\
